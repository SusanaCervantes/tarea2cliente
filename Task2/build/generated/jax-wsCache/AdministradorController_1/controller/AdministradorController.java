...
public interface AdministradorController {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getAdmiLogging", targetNamespace = "http://controller/", className = "controller.GetAdmiLogging")
    @ResponseWrapper(localName = "getAdmiLoggingResponse", targetNamespace = "http://controller/", className = "controller.GetAdmiLoggingResponse")
    @Action(input = "http://controller/AdministradorController/getAdmiLoggingRequest", output = "http://controller/AdministradorController/getAdmiLoggingResponse")
    public List<AdministradorDto> getAdmiLogging(
